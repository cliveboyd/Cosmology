...
Curated analysis scripts copied from the local working tree.

Subfolders:

- `rawmu/` - hierarchical raw-MU and redshift-frame diagnostics.
- `bao/` - BAO observable adapters, covariance validation, and external distance-scale tests.
...
- `hht_cmb_sn/` - HHT residual, CMB/SN legacy, and BAO-lock screening tools.
- `shared/` - shared model/utilities used by more than one diagnostic.
