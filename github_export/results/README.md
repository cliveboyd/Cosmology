...
- `2026-07-16/rawmu/` contains the FR `c(z)=c0(1+z)` no-loss dimming sequence for raw supernova MU, comparing `alpha = 0, 0.5, 1` under the July 14 calibration/redshift-frame controls.
