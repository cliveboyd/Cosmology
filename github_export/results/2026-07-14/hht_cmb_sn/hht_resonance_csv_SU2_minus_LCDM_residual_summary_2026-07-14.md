...
x column: `log1pz`
y column: `delta_residual_SU2_baocov_4D_minus_LCDM_baocov`
reference column: ``
...
- hht_resonance_csv_SU2_minus_LCDM_residual_imf_summary.csv
- hht_resonance_csv_SU2_minus_LCDM_residual_overview.png
